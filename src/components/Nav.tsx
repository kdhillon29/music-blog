...
function Nav() {
  ...
  return (
    <nav
      class="relative flex items-center pt-10 sm:pt-5 sm:px-3 dark:bg-gray-900"
                ...
                <ul>
                  <li>
                    <a
                      href="/"
                      aria-current="page"
                      class="text-gray-900 dark:text-white pb-8"
                    >
                      <svg
                        width="138"
                        height="20"
              ...
              <div>
                <ul class="flex items-center space-x-7">
                  <li>
                    <a
                      href="#"
                      class="font-Kumbh h-20 font-medium pb-8 text-xl text-gray-600 dark:text-white hover:text-gray-900 hover:font-semibold hover:border-b-4 hover:border-yellow-600"
                    >
                      Collections
                    </a>
                  </li>
